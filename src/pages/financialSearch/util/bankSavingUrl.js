...
// 은행 코드별 적금 안내 페이지 URL 매핑 
const bankSavingUrlMap = {
    ...
    '0010017': 'https://www.busanbank.co.kr/ib20/mnu/FPMDPO012002001',
    ...
    '0010024': 'https://www.busanbank.co.kr/ib20/mnu/FPMDPO012002001',
    ...
    '0013175': 'https://smartmarket.nonghyup.com/servlet/BFDCW1013R.view',
    ...
    '0015130': 'https://www.kakaobank.com/products/savings',
    '0017801': 'https://www.tossbank.com/product-service/savings/savings-growth',
  };
  
  export function getBankSavingUrl(bankCode) {
    return bankSavingUrlMap[bankCode] || '#';
  } 